...
public class MemberJpaRepository {
    ...
    //1번 방법: JPAQueryFactory의 생성자에 직접 em 넣어주기_장점: 테스트 코드 간결/ 소스 길어짐
   public MemberJpaRepository(EntityManager em) {
        this.em = em;
        this.queryFactory = new JPAQueryFactory(em);// <- 취향 차이 1. 이렇게 사용해도 되고, 2. 스프링 bean을 등록해도 된다.
    }

    //2번 방법: @SpringBootApplication 에 bean 등록하기_@RequiredArgsConstructor 사용 가능/ 테스트코드짤때 귀찮아짐
